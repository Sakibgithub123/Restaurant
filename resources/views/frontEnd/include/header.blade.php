...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
        ...
        <h1 class="logo me-auto me-lg-0"><a href="{{route('home')}}">Restaurantly</a></h1>
        ...
        <a href="{{route('tableBook')}}" class="book-a-table-btn scrollto d-none d-lg-flex">Book a table</a>
